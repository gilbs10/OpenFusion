...
#define SOFTKINETIC_K1 -0.1610
#define SOFTKINETIC_K2 0.0722
#define SOFTKINETIC_P1 0.0013
#define SOFTKINETIC_P2 0.0001
...
tthread::mutex depth_mutex;
tthread::mutex rgb_mutex;
